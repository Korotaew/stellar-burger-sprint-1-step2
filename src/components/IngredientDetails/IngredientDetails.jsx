    ...
    return (
        <Modal onClose={onClose} isHeaderShow={true}>
            <div className={styles.ingredientDetail}>
                ...
                <p className={`text text_type_main-medium mb-8 ${styles.name}`}>
                    {ingredient.name}
                </p>
                <div className={`${styles.items} mb-5`}>
                    <div className={styles.column}>
                        <p className="text text_color_inactive text_type_main-default mb-2">
                            Калории
                        </p>
                    ...
                    <div className={styles.column}>
                        ...
                        <p className="text text_color_inactive text_type_digits-default text_color_inactive">
                            {ingredient.proteins}
                        </p>
                    </div>
                    <div className={styles.column}>
                    ...
                    <div className={styles.column}>
                        ...
                        <p className="text text_color_inactive text_color_inactive text_type_digits-default">
